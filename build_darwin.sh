...
xcodebuild -create-xcframework -library build_ios/install/lib/libsentencepiece.a -headers build_ios/install/include -library build_macos/install/lib/libsentencepiece.a -headers build_macos/install/include -library build_iphonesimulator/install/lib/libsentencepiece.a -headers build_iphonesimulator/install/include -output libsentencepiece.xcframework